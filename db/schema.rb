...
ActiveRecord::Schema.define(version: 20_150_904_024_304) do
  ...
  add_index 'items_categories', %w(item_id category_id), name: 'item_category_index', unique: true, using: :btree
  ...
  create_table 'ratings', force: :cascade do |t|
    ...
    t.text 'text_rating', limit: 65_535
    t.datetime 'created_at'
    t.datetime 'updated_at'
  end
